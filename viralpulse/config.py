...
# ─────────────────────────────────────────────────────
SKILL_DIR = Path.home() / ".viralpulse"
...
def get_claude_backend() -> str:
    ...
    raise RuntimeError(
        ...
        "  1. Set ANTHROPIC_API_KEY in env or ~/.viralpulse/config.json\n"
...
def run_setup():
    ...
    print("\n" + "=" * 60)
    print("  ViralPulse v3 — First-Run Setup")
    print("=" * 60)
    print("\nThis wizard will configure your API keys and YouTube access.")
    print("Keys are saved to ~/.viralpulse/config.json\n")
