"""CLI entry point — python -m viralpulse."""
...
def cmd_produce(args):
    ...
    if srt_path and Path(srt_path).exists():
        final_srt = MEDIA_DIR / f"viralpulse_{job_id}_{lang}.srt"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="ViralPulse v3 — AI-Native Vertical Video Engine",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="Docs: https://github.com/nova-hermes/viralpulse\n"
